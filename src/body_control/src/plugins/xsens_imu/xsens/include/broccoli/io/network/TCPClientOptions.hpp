...
namespace io {
    ...
    //! Container for options of \ref NetworkSocket of type \ref NetworkSocketType::TCP_CLIENT
    class TCPClientOptions : public NetworkSocketOptions {
    public:
        //! Constructor
        /*!
         ...
         */
        TCPClientOptions(const std::string& name, const std::string& remoteIP, const int& remotePort, const bool& multiThreaded, const int& threadPriority, const core::Time& minimumCycleTime, const bool& blockingWaiting, const size_t& receivedObjectBufferSize, const size_t& sendObjectBufferSize, const serialization::Endianness& endianness = serialization::Endianness::LITTLE)
            : NetworkSocketOptions(NetworkSocketType::TCP_CLIENT, name, remoteIP, remotePort, 0, multiThreaded, threadPriority, minimumCycleTime, blockingWaiting, receivedObjectBufferSize, sendObjectBufferSize, endianness)
        {
        }
    };
